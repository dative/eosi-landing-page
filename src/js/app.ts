...
const VideoModal = (el: Element) => {
  ...
  const _renderFrame = () => {
    ...
    iframe.setAttribute(
      'class',
      'w-[100vw] h-[56.25vw] sm:w-[90vw] sm:h-[50.625vw] lg:w-[75vw] lg:h-[42.1875vw] z-50 md:rounded lg:rounded-lg'
    )
  ...
  const _renderModal = () => {
    ...
    closeIconBtn.classList.add('fixed', 'top-4', 'right-4', 'w-6', 'h-6')
